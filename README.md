...
-use authentication measures, such as tokens, and privateRoutes
- [ ] Describe how web servers work.
-Computers connect to the internet via the internet, find a specific server computer through a URL and retrive info or resources through that server.
